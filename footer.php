			...
			<div class="row-fluid">
				...
				<div class="span8">
					<p class="foot-message">
						<a href="https://bsky.app/profile/edpsy.bsky.social" style="vertical-align: middle;"><img
								height="22px" src="<?php echo get_template_directory_uri(); ?>/images/bluesky.svg"
						...
						<a href="mailto:hello@edpsy.org.uk"><i class="fal fa-envelope"></i> hello@edpsy.org.uk</a>
					</p>
					<p class="foot-message"><a href="/about/">Find out more about us</a><br />Spotted something wrong?
						<a href="mailto:hello@edpsy.org.uk">let us know</a></p>
					<p class="foot-message"><a href="/community-guidelines">Community guidelines</a> | <a
	...
	<div class="third_wrapper">
		<div class="container">
			<div class="row-fluid">
				...
				<p class="legal-message"><span>edpsy ltd </span><span>Piccadilly Business Centre, Aldow Enterprise Park,
						Manchester, England, M12 6AE</span><span>Company number: 12669513 (registered in England and
						Wales)</span></p>
...
<!-- #wrapper -->
<a href="JavaScript:void(0);" title="<?php _e('Back To Top', 'advertica-lite'); ?>" id="backtop"><i
