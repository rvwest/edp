...
<!-- Featured Box 4 -->
			<div class="mid-box span4 fade_in_hide element_fade_in" >
				<div class="skt-iconbox iconbox-top">
					<div class="iconbox-icon skt-animated small-to-large skt-viewport">
					<?php if( get_theme_mod('fourth_feature_image', '') != '' ) { ?>
						<a class="skt-featured-images" href="<?php echo esc_url( get_theme_mod('fourth_feature_link', '#') ); ?>" title="<?php echo esc_attr( get_theme_mod('fourth_feature_heading', __('Quality Products', 'advertica-lite') ) ); ?>">
								<span class="skt-featured-image-mask"></span>
								<img class="skin-bg" src="<?php echo esc_url( get_theme_mod('second_feature_image') ) ?>" alt="boximg"/>
							</a>
					  <?php } else { ?>
						<a class="skt-featured-icons" href="<?php echo esc_url( get_theme_mod('fourth_feature_link', '#') ); ?>" title="<?php echo esc_attr( get_theme_mod('fourth_feature_heading', __('Quality Products', 'advertica-lite') ) ); ?>">
							<i class="fas fa-chart-bar"></i>
						</a>
					  <?php  } ?>
					</div>
					<div class="iconbox-content">
						<h4 id="fourth-feature-heading"><?php echo esc_attr( get_theme_mod('fourth_feature_heading', __('Quality Products', 'advertica-lite') ) ); ?></h4>
						<p><?php echo wp_kses_post( get_theme_mod('fourth_feature_content', __('Products with the ultimate features and functionality that provide the complete satisfaction to the clients.', 'advertica-lite') ) ); ?></p>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
