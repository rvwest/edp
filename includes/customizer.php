...
function advertica_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'home_promo_section' , array(
		'title' => __('Home Promo Block','advertica-lite'),
		'panel' => 'home_page_settings',
	) );
	...
	$wp_customize->add_section( 'home_feat_section' , array(
		'title' => __('Home Feature Articles','advertica-lite'),
		'panel' => 'home_page_settings',
	) );
...
// Fourth Featured Box
	$wp_customize->add_setting( 'fourth_feature_heading', array(
		'default'        => __('Quality Products', 'advertica-lite'),
		'sanitize_callback' => 'advertica_lite_sanitize_textarea',
	));
	$wp_customize->add_control('fourth_feature_heading', array(
		'label' => __('Fourth Featured Box Heading','advertica-lite'),
		'section' => 'home_featured_section',
		
	));
	$wp_customize->add_setting( 'fourth_feature_image', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'fourth_feature_image', array(
		'label' => __( 'Fourth Featured Box Image', 'advertica-lite' ),
		'section' => 'home_featured_section',
		
	) ) );
	$wp_customize->add_setting( 'fourth_feature_content', array(
		'default'        => __('Products with the ultimate features and functionality that provide the complete satisfaction to the clients.', 'advertica-lite'),
		'sanitize_callback' => 'advertica_lite_sanitize_textarea',
	));
	$wp_customize->add_control('fourth_feature_content', array(
		'type' => 'textarea',
		'label' => __('Fourth Featured Box Content','advertica-lite'),
		'section' => 'home_featured_section',
		
	));
	$wp_customize->add_setting( 'fourth_feature_link', array(
		'default'        => '#',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control('fourth_feature_link', array(
		'type' => 'url',
		'label' => __('Fourth Featured Box Link','advertica-lite'),
		'section' => 'home_featured_section',
	...
	$wp_customize->add_control( 'home_parallax_sec', array(
		'label' => __( 'Home parallax ON/OFF', 'advertica-lite' ),
	...
	$wp_customize->add_setting( 'home_promo_sec', array(
		'default'           => 'on',
		'sanitize_callback' => 'advertica_lite_sanitize_on_off',
	) );
	$wp_customize->add_control( 'home_promo_sec', array(
		'label' => __( 'Home promo block ON/OFF', 'advertica-lite' ),
		'section' => 'home_promo_section',
		'type' => 'radio',
		'choices' => array(
			'on' =>'ON',
			'off'=> 'OFF'
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'promo_image', array(
		'label' => __( 'Home promo image', 'advertica-lite' ),
		'section' => 'home_promo_section',
	) ) );
	
	
	$wp_customize->add_setting( 'promo_url', array(
		'default'        => '#',
		'sanitize_callback' => 'advertica_lite_sanitize_textarea',
	));
	$wp_customize->add_control('promo_url', array(
		'label' => __('Home promo link','advertica-lite'),
		'section' => 'home_promo_section',
		'description' => 'eg. /blog/blog-title'
	));

	$wp_customize->add_setting( 'promo_content', array(
		'default'        => '<div class="skt-awesome-section"><div class="skt-awesome-title">'.__('Promo Section', 'advertica-lite').'</div><div class="skt-awesome-desp">'.__('Promo section text here', 'advertica-lite').'</div></div>',
		'sanitize_callback' => 'advertica_lite_sanitize_textarea',
	));
	$wp_customize->add_control('promo_content', array(
		'type' => 'textarea',
		'label' => __('Home Promo Content','advertica-lite'),
		'section' => 'home_promo_section',
	));
	...
	$wp_customize->add_setting( 'home_blog_title', array(
		'default'        => __('Blogs', 'advertica-lite'),
		'sanitize_callback' => 'advertica_lite_sanitize_textarea',
	));
	...
	// ====================================
	$wp_customize->add_setting( 'home_feat_sec', array(
		'default'           => 'on',
		'sanitize_callback' => 'advertica_lite_sanitize_on_off',
	) );
	$wp_customize->add_control( 'home_feat_sec', array(
		'label' => __( 'Home Features ON/OFF', 'advertica-lite' ),
		'section' => 'home_feat_section',
		'type' => 'radio',
		'choices' => array(
			'on' =>'ON',
			'off'=> 'OFF'
	...
	$wp_customize->add_setting( 'home_feat_title', array(
		'default'        => __('Features', 'advertica-lite'),
		'sanitize_callback' => 'advertica_lite_sanitize_textarea',
	));
	$wp_customize->add_control('home_feat_title', array(
		'label' => __('Home Features Title','advertica-lite'),
		'section' => 'home_feat_section',
	));

	$wp_customize->add_setting( 'home_feat_num', array(
		'default'        => __('6', 'advertica-lite'),
		'sanitize_callback' => 'advertica_lite_sanitize_textarea',
	));
	$wp_customize->add_control('home_feat_num', array(
		'label' => __('Number Of feature articles','advertica-lite'),
		'section' => 'home_feat_section',
	));
	// ====================================
 ...
 *
* changed wp_fueue_script to wp_enqueue_script()
*/
