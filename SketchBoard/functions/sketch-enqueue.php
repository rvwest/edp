...
function advertica_lite_script_enqueqe() {
	...
	if(!is_admin()) {
		wp_enqueue_script('advertica-lite-custom-js', get_template_directory_uri() .'/js/custom.min.js',array('jquery'),'1.0',1 );
...
/*	wp_enqueue_script('hoverIntent');*/
 wp_enqueue_script('advertica-lite-superfish-js', get_template_directory_uri().'/js/superfish.min.js',array('jquery'),true,'1.0');
...
/*	wp_enqueue_style('advertica-lite-animation-stylesheet', get_template_directory_uri().'/css/skt-animation.css', false, $theme->Version);*/
	...
	// Google Fonts
	wp_enqueue_style('advertica-lite-googlefont-opensans', '//fonts.googleapis.com/css?family=Open+Sans:800,700,600,300,200,100&subset=latin,latin-ext');
