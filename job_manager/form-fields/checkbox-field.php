...
?>
<?php if ( ! empty( $field['description'] ) ) : ?><p class="description"><?php echo wp_kses_post( $field['description'] ); ?></p><?php endif; ?>
...
<span class="checkbox-label"><?php echo empty( $field['placeholder'] ) ? '' : esc_attr( $field['placeholder'] ); ?></span>
